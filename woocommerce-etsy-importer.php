...
Plugin URI:
Description: Import products, categories, from Etsy
Author: Hugo Vacher
Version: 0.0.1
Author URI: https://github.com/Korri
*/
            ...
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
                ...
                <p>
                    <label>osCommerce store URL: <input type="text" name="store_url"
                                                        value="<?php echo $_POST['store_url']; ?>"></label>
                </p>
